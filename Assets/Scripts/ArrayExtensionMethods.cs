...
{
    public static int sumn(this int a, int n)
    {
        return a + n;
    }
    ...
    //Devuelve una lista de enteros con el contenido de 'a' a excepción de las partes que haya que quitar especificado en 'indicesToRemove'. 'a' debe tener el mismo tamaño que 'indicesToRemove'
    ...
    public static List<Vector3> RemoveAllSpecifiedIndicesFromArray(this Vector3[] a, bool[] indicesToRemove)
    {
